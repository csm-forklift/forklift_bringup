...
# Test starting point
rosrun cartographer_ros cartographer_start_trajectory -configuration_directory "/home/csm/cartographer_latest/install_isolated/share/cartographer_ros/configuration_files" -configuration_basename "realtime_2d_turtlebot.lua" -initial_pose "{to_trajectory_id = 0,relative_pose = {$STARTING_POINT}, timestamp = 0}" &
